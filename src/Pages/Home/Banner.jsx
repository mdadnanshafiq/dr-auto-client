...
const Banner = () => {
  return (
    <div className=" relative *:lg:rounded-lg">
      <div className="absolute z-20 top-1/2 left-[10%] p-6 -translate-y-1/2  flex flex-col justify-center items-start gap-6 ">
        ...
        <div className="flex flex-col lg:flex-row justify-start items-center gap-6">
          ...
          <button className="btn btn-outline text-white outline-white font-bold">
            Latest Project
          </button>
        </div>
      </div>
      <div className="carousel lg:h-[60vh] h-screen w-full ">
        {/* <div className="absolute z-10 lg:h-[60vh] h-screen bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0.00)] size-full"></div> */}
